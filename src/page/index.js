...
class NewsVisualization extends React.Component {
  ...
  getMatchItems(data) {
    ...
    $.ajax({
      ...
      data: postData,
      success: data => {
        this.setState({matchContent: data[0]['content'], matchUrl: data[0]['url']
        })
      },
      error: err => {
        console.log(err);
        ...
        <Header className='header'>
          <Menu theme='dark' mode='horizontal' style={{
            ...
            <Menu.Item style={{
              ...
              <Router>
                <Link to="/">
                  <img src="/images/logocp.png" style={{
                      marginLeft: '-40px',
                      marginRight: '50px'
                    }}/>
                </Link>
            ...
            <Menu.Item style={{
              ...
              <Select defaultValue={this.state.year} style={{
                  maxWidth: 240,
                  minWidth: '120px'
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;
              <Select defaultValue={this.state.month} style={{
                  maxWidth: 240,
                  minWidth: '120px'
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;
              <Select defaultValue={this.state.day} style={{
                  maxWidth: 240,
                  minWidth: '120px'
