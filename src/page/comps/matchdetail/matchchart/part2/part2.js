...
class Part2 extends React.Component {
  ...
  handleProps(data) {
    ...
    this.setState({team1Detail: team1Detail, team2Detail: team2Detail, team1Summary: data[0]['team1Summary'], team2Summary: data[0]['team2Summary'], team1Name: data[0]['team1Info'][1],
