...
class Part1 extends React.Component {
  ...
  handleProps(data) {
    this.setState({team1Name: data[0]['team1Info'][1],
        ...
        <Col span={6} style={{
          ...
          <Row>
            <Col span={12} style={{
              ...
              <h3>
                <b onClick={(e) => this.handleModal(e)} style={{
                    cursor: 'pointer',
                    color: 'rgba(24,144,255,1)'
                  }}>{team1Name}</b>
              </h3>
              <Modal title={modalTarget} visible={this.state.modalVisible} onOk={(e) => this.handleOk(e)} onCancel={(e) => this.handleCancel(e)} footer={null}>
